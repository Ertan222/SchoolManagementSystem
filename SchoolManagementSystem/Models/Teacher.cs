...
{
    public class Teacher : ClassMembersBaseEntity, IHuman
    {
        [Key]
        ...
        [Required(ErrorMessage = "{0} must be filled."), Display(Name = "Lastname"), StringLength(40, MinimumLength = 3, ErrorMessage = "{0} {2} - {1} needs to be in range .")]
